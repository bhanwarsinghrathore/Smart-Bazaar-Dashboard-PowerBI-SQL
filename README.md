# Smart Bazaar-Dashboard-PowerBI-SQL
## Sales & Performance Analysis

**Tools Used:** SQL | MySQL | Power BI | Excel | DAX

- [Datasets Used] - https://github.com/bhanwarsinghrathore/Smart-Bazaar-Dashboard-PowerBI-SQL/blob/main/Big%20Bazaar.csv

- [SQL Analysis (Code)] - https://github.com/bhanwarsinghrathore/Smart-Bazaar-Dashboard-PowerBI-SQL/blob/main/smart_bazaar.sql

- [smart Bazaar Dashboard - Power Bi] - https://github.com/bhanwarsinghrathore/Smart-Bazaar-Dashboard-PowerBI-SQL/blob/main/Smart_Bazaar_Power_BI.pbix
...
## Project Objective**
Analyze retail sales data to identify product and outlet performance,
sales trends, customer ratings, and high-contributing product categories.
The analysis uses MySQL for data exploration and Power BI for
interactive visualization and business insights.
...
## 2. Total item weight by Outlet Location Type
```mysql
SELECT
...
## 3. Minimum, Maximum, and Average Sales by Outlet Type
```mysql
SELECT 
    outlet_type,
...
```
## 7. Products available across multiple outlet types
top 10 
```mysql
SELECT 
    Item_Identifier,
    COUNT(DISTINCT Outlet_Type) AS outlet_type_count
FROM smart_bazaar
...
## 11. Top 2 Performing Products in Each Outlet
```mysql
